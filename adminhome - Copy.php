...
<div class="row">  
		...
		<div class="navbar1 ropright">
			<div class="dropdown1">
			  <button class="dropbtn1 dropdown-toggle" data-toggle="dropdown">Routine</button>
				...
				<a href="application.php"><i class=""></i>Adminssion</a>
 ...
 <div class="row">
	...
	<div class="col-sm-4 text-light"><h1 style="margin-left:5%">Admin Dashboard</h1></div>
	 
	</div>	 
		
	<div class="row" style="widht:100%;margin-left:auto">
            ...
            <div class="card-body">
                <p class="card-text">	
					...
					<?php 
						...
						$sql = "SELECT COUNT(*) as username FROM user WHERE usertype='Student' AND DATE(time) = CURDATE()";
						$result = $data->query($sql);
